...
def random_mutation_spanset_generator(number_of_mutation, path_to_export = "/Users/ugursahin/Downloads/Frequency-Based-Mutation-Estimation-Algorithm-main/dbs"):
...
def random_patient_dbs_generator(number_of_cases, number_of_different_mutations, path_to_export = "/Users/ugursahin/Downloads/Frequency-Based-Mutation-Estimation-Algorithm-main/dbs"):
...
if __name__ == '__main__':
    print(random_mutation_spanset_generator(100))
    print(random_patient_dbs_generator(100,100))